...
export {
    ...
    JOINT_LIFT_ARM_ACTIONS,
    JOINT_MOVE_ACTIONS,
    JOINT_WRIST_ACTIONS, LOAD_AUTONAV_LOCATION, MAIN_MENU_ACTIONS, MOVE_TO_POSE, REPEAT_BASE_MOVE, SAVE_MAP_LOCATION, SAVE_POSE, SAVED_LOCATIONS_MODAL_ACTIONS, SAVED_POSES_MODAL_ACTIONS, SET_MAIN_MENU, SET_SAVED_LOCATIONS_MODAL, SET_SAVED_POSES_MODAL, STOP_MOTION, SWITCH_SCENE, VOICE_DISTANCE_M_MAX, VOICE_DISTANCE_M_MIN, VOICE_DURATION_MS_DEFAULT,
    VOICE_DURATION_MS_MAX,
...
/** All valid set_main_menu.action values. */
export type MainMenuAction = (typeof MAIN_MENU_ACTIONS)[number];

/** Result of set_main_menu for toast UX. */
export type SetMainMenuResult = {
    ok: boolean;
    detail: string;
};
