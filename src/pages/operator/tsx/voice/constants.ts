...
export {
    ...
    JOINT_LIFT_ARM_ACTIONS,
    JOINT_MOVE_ACTIONS,
    JOINT_WRIST_ACTIONS, LOAD_AUTONAV_LOCATION, MAIN_MENU_ACTIONS, REPEAT_BASE_MOVE, SAVE_MAP_LOCATION, SAVED_LOCATIONS_MODAL_ACTIONS, SET_MAIN_MENU, SET_SAVED_LOCATIONS_MODAL, STOP_MOTION, SWITCH_SCENE, VOICE_DISTANCE_M_MAX, VOICE_DISTANCE_M_MIN, VOICE_DURATION_MS_DEFAULT,
    VOICE_DURATION_MS_MAX,
